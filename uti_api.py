...
WAYS_TO_CONVERT = [(ENCODE_WAY_1, 'Default way'), (PASSWORD_ENCODE, 'Password way')]
DECODE_WAYS = [DECODE_WAY_1, 'PASSWORD']
...
if __name__ == '__main__':
    image = ImageUti.import_image('mega_image.uti')
    print(image.get_qimage())
    print(1)